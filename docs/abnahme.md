...
Der anschließende [lokale Rust-RTMPS-Nachweis](rtmps-nachweis.md) belegt AV1/H.264 mit zwei AAC-Spuren, Paket-/Headertreue, getrennte Verbindungsgenerationen und TLS-Negativfälle. Der [gemeinsame Review](review-rtmps.md) und der [separate Sicherheitsreview](review-security-rtmps.md) sind auf dem korrigierten Stand abgeschlossen. Öffentliche Brokeranbindung, Standard-OBS und Plattformausgänge bleiben offen.
