...
mod tests {
    ...
    use crate::handshake::complex::{
        RTMP_CLIENT_KEY_FIRST_HALF, RTMP_SERVER_KEY, RTMP_SERVER_KEY_FIRST_HALF,
        RTMP_SERVER_VERSION, SchemaVersion,
    };
    ...
    fn test_complex_handshake() {
        ...
        let data_digest =
            DigestProcessor::new(Bytes::copy_from_slice(s1), RTMP_SERVER_KEY_FIRST_HALF);
