...
// Modified by Uplink: bounded, fully consumed Serde containers; see ../../PATCHES.md.
    ...
    R: ZeroCopyReader<'de>,
{
        ...
        V: serde::de::Visitor<'de>,
    {
        self.with_container(|decoder| {
            let size = decoder.decode_strict_array_header()? as usize;
            let mut access = StrictArray {
                de: decoder,
                remaining: size,
            };
        ...
        V: serde::de::Visitor<'de>,
    {
        self.with_container(|decoder| {
            ...
            if !access.finished && access.de.decode_object_key()?.is_some() {
                return Err(Amf0Error::IncompleteContainer);
            }
            Ok(value)
        })
    ...
    R: ZeroCopyReader<'de>,
{
        ...
        T: serde::de::DeserializeSeed<'de>,
    {
        ...
        let before = self.de.progress();
        let value = seed.deserialize(&mut *self.de)?;
        self.de.require_progress(before)?;
        self.remaining -= 1;
        Ok(Some(value))
    }
    ...
    R: ZeroCopyReader<'de>,
{
        ...
        K: serde::de::DeserializeSeed<'de>,
    {
        ...
        self.de.check_entries(self.entries)?;
